...
const MainPage = () => {
    ...
    return (
        ...
        // <div className="min-h-screen relative overflow-hidden bg-FFF275">
        ...
        //         </div>
        //
        //         <div className="position-absolute top-300px left-200px"
        //              style={{animation: "bounce 1.5s infinite ease-in-out 0.5s", transform: "scale(0.6) rotate(15deg)"}}>
        //             <img src={chick1} alt="chick1" className="width-118px"/>
        //         </div>
        //
        //         <div className="position-absolute point-auto top-400px left-80px">
        //             <p className="weight-600 font-size-24px">
        //                 다시는 돌아오지 않을 <span className="weight-700" style={{color: "#FF6B6B"}}>지금</span>을 사진으로
        //             </p>
        //         </div>
        //
        //         <div className="position-absolute point-auto top-420px left-76px">
        ...
        //         </div>
        //
        //         <button className="flex justify-center items-center gap-1rem weight-600 position-absolute point-auto cursor-pointer font-size-32px rounded-20px top-580px left-76px width-338px height-78px bg-white color-020E2E border-3px-solid-black boxshadow-0-4-8-rgba-0-0-0-0-2"
        //                 onClick={() => navigate('/picture/select-frame')}
        //                 style={{
        //                     transition: "all 0.3s ease",
        //                     transform: "rotate(-2deg)",
