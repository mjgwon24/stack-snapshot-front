        ...
        <div style={{display: "flex", flexDirection: "column", alignItems: "center"}}>
            <div className="big-grid-frame">
                ...
                <div className="grid-title">
                    <svg width="428" height="93" viewBox="0 0 428 93" fill="none" xmlns="http://www.w3.org/2000/svg"
                         className="title">
                        ...
                        <defs>
                            <filter id="filter0_d_13_1800" x="0.8703" y="0.213867" width="385.025" height="114.547"
                                ...
                                <feColorMatrix type="matrix"
                                               values="0 0 0 0 0.905882 0 0 0 0 0.917647 0 0 0 0 0.945098 0 0 0 0.4 0"/>
                                <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_13_1800"/>
                                <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_13_1800"
                                         result="shape"/>
                            </filter>
                        </defs>
                    </svg>
                ...
                <div></div>
                <div className="main-frame"><img className={`${currnetFrameClass} big`} src={currnetFrame}
                                                 alt="mainframe"></img></div>
                <div></div>
                <div className="div-frame-grid">
                    <div className="frame-grid">
                        ...
                        {Object.keys(frames).map((value, index) => {
                            return (
                                <img className={`frame ${value} small ${frames[value]["selected"] ? "selected" : ""}`}
                                     src={frames[value]["frame"]} alt={`${value}`} onClick={() => {
                                    change_frame(value)
                                }}></img>
                            );
                        })}
                ...
                <div></div>
                <div
                    className="next-btn">{Object.keys(frames).reduce((acc, key) => acc || frames[key]["selected"], false)
                    ?
                    <Link to={`/picture?frameid=${FRAMES[currnetFrameClass]["frameID"]}`}>
                        <svg className="next-btn-svg" width="75" height="75" viewBox="0 0 75 75" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <rect width="75" height="75" rx="12" fill="#080E1C"/>
                            <path
                                d="M35.1328 47.3594L43.5703 38.9219H23.7266V34.3125H43.5703L35.1328 25.9141L38.2969 22.7891L52.1641 36.6172L38.2969 50.4844L35.1328 47.3594Z"
                                fill="#D2D5DC"/>
                        </svg>
                    </Link>
                    :
